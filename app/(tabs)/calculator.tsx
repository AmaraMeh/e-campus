...
export default function CalculatorScreen() {
    ...
    // --- Render Module Card ---
    const renderModuleCard = (module: Module, index: number) => { // Added index
        const moduleKey = module.id;
        ...
        return (
            <Animated.View key={moduleKey} entering={FadeInUp.delay(100)} style={styles.moduleCard}>
    ...
    const calculateMinExamGrade = (module: Module) => {
        ...
        const message = examGrade <= 0 ? 'Already passed.' : examGrade > 20 ? 'Impossible to pass.' : `Need ${examGrade.toFixed(2)}/20 in exams.`;
                ...
                {isLoadingData ? (
                    ...
                    <>
                        ...
                        <View style={styles.modulesSection}>
                            {currentModules.map((module, index) => renderModuleCard(module, index))} {/* Added index */}
